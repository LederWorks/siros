...
func (m *mockResourceRepository) Create(ctx context.Context, resource *models.Resource) error {
	m.resources[resource.ID] = resource
	return nil
}

func (m *mockResourceRepository) GetByID(ctx context.Context, id string) (*models.Resource, error) {
...
func (m *mockResourceRepository) Update(ctx context.Context, resource *models.Resource) error {
...
func (m *mockResourceRepository) List(ctx context.Context, query models.SearchQuery) ([]models.Resource, error) {
...
func (m *mockResourceRepository) Search(ctx context.Context, query models.SearchQuery) ([]models.Resource, error) {
	return m.List(ctx, query)
}

func (m *mockResourceRepository) GetByParentID(ctx context.Context, parentID string) ([]models.Resource, error) {
	var result []models.Resource
	for _, resource := range m.resources {
...
func (m *mockResourceRepository) VectorSearch(ctx context.Context, vector []float32, threshold float32, limit int) ([]models.Resource, error) {
	return []models.Resource{}, nil
}

type mockVectorService struct{}

func (m *mockVectorService) GenerateVector(ctx context.Context, data map[string]interface{}, metadata models.ResourceMetadata) ([]float32, error) {
	return []float32{1.0, 2.0, 3.0}, nil
}

func (m *mockVectorService) FindSimilarResources(ctx context.Context, vector []float32, threshold float32, limit int) ([]models.Resource, error) {
	return []models.Resource{}, nil
}

func (m *mockVectorService) UpdateVector(ctx context.Context, resourceID string, vector []float32) error {
	return nil
}

type mockBlockchainService struct{}

func (m *mockBlockchainService) RecordChange(ctx context.Context, resourceID, operation, actor string, changes map[string]interface{}) error {
	return nil
}

func (m *mockBlockchainService) GetAuditTrail(ctx context.Context, resourceID string) ([]models.ChangeRecord, error) {
	return []models.ChangeRecord{}, nil
}

func (m *mockBlockchainService) VerifyIntegrity(ctx context.Context, resourceID string) (bool, error) {
	return true, nil
}
